...
class Terms {
  ...
  toByteString() {
    ...
    version = Util.padLeft(version, 2) // uint8
    periodType = Util.padLeft(periodType, 2) // uint8
    periodLength = Util.padLeft(periodLength, 64) // uint256
    termLength = Util.padLeft(termLength, 64) // uint256
    compounded = Util.padLeft(compounded, 2) // bool
