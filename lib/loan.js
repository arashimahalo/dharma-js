...
class Loan extends RedeemableERC20 {
  constructor(web3, params) {
    ...
    this.terms = util.generateTermsByteString(params.terms);
    this.attestor = params.attestor;
    this.attestorFee = params.attestorFee;
    this.defaultRisk = params.defaultRisk;
    this.signature = params.signature;
    this.auctionPeriodLength = params.auctionPeriodLength;
    this.reviewPeriodLength = params.reviewPeriodLength;
